var app = (function () {
    ...
    /* src\Player.svelte generated by Svelte v3.31.0 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button0, "class", "plus svelte-3e63i0");
    			button1.disabled = /*gameOver*/ ctx[4];
    			attr(button1, "class", "minus svelte-3e63i0");
    			set_style(div, "color", /*fontColor*/ ctx[3]);
    			attr(div, "class", "player svelte-3e63i0");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "svelte-1ormvmz");
    			attr(button, "class", "svelte-1ormvmz");
    			attr(main, "class", "svelte-1ormvmz");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*blueScore*/ 1) player0_changes.score = /*blueScore*/ ctx[0];
    			...
    			if (dirty & /*redScore*/ 2) player1_changes.score = /*redScore*/ ctx[1];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function updateBlueScore(e) {
    		...
    		$$invalidate(0, blueScore += updateScore);
    	}

    	function updateRedScore(e) {
    		const updateScore = e.detail;
    		$$invalidate(1, redScore += updateScore);
    	}

    	function newGame() {
    		$$invalidate(1, redScore = 20);
    		$$invalidate(0, blueScore = 20);
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*redScore*/ 2) {
    			 $$invalidate(2, blueWon = redScore <= 0);
    		}

    		if ($$self.$$.dirty & /*blueScore*/ 1) {
